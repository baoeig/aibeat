...
按操作系统选择。以下 **v0.4.1 完整包**包含 CLI、示例、Skills、Node.js 和评测运行时，完成本文步骤不需要另装运行时。

<CardGroup cols={2}>
  <Card title="macOS · Apple Silicon" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.4.1/promptbeat-0.4.1-darwin-arm64.tar.gz">下载 .tar.gz</Card>
  <Card title="macOS · Intel" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.4.1/promptbeat-0.4.1-darwin-x64.tar.gz">下载 .tar.gz</Card>
  <Card title="Linux · x64" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.4.1/promptbeat-0.4.1-linux-x64.tar.gz">下载 .tar.gz</Card>
  <Card title="Windows · x64" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.4.1/promptbeat-0.4.1-windows-x64.zip">下载 .zip</Card>
</CardGroup>

[版本说明与文件校验值](https://github.com/tophant-ai/aibeat/releases/tag/v0.4.1) · [GitHub 仓库](https://github.com/tophant-ai/aibeat)
