...
<CardGroup cols={2}>
  <Card title="macOS · Apple Silicon" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.2/promptbeat-0.2-darwin-arm64.tar.gz">Download .tar.gz</Card>
  <Card title="macOS · Intel" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.2/promptbeat-0.2-darwin-x64.tar.gz">Download .tar.gz</Card>
  <Card title="Linux · x64" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.2/promptbeat-0.2-linux-x64.tar.gz">Download .tar.gz</Card>
  <Card title="Windows · x64" icon="download" href="https://github.com/tophant-ai/aibeat/releases/download/v0.2/promptbeat-0.2-windows-x64.zip">Download .zip</Card>
</CardGroup>

[Release notes and asset checksums](https://github.com/tophant-ai/aibeat/releases/tag/v0.2) · [GitHub repository](https://github.com/tophant-ai/aibeat)
